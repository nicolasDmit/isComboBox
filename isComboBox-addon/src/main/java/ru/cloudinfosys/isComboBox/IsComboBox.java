...
public class IsComboBox extends com.vaadin.ui.AbstractSelect
    ...
    public IsComboBox(String caption, Collection<?> options) {
        super(caption, options);
        initDefaults();
    }

    public IsComboBox(String caption, Container dataSource) {
        super(caption, dataSource);
        initDefaults();
    }

    public IsComboBox(String caption) {
        super(caption);
        initDefaults();
    }

    /**
     * Initialize the IsComboBox with default settings
     */
    ...
    /**
     * @deprecated As of 7.0, replaced by {@link #addBlurListener(FieldEvents.BlurListener)}
     **/
    @Override
    @Deprecated
